## I used the following python command to run the file: PYTHONPATH=. python 'train_and_data_generation/train_BF_CNN_image_denoiser.py' --output-dir 'image_denoiser_experiments'
...
#     train_loader, valid_loader, _ = data.build_dataset(args.dataset, args.data_path, batch_size=args.batch_size)
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        for batch_id, inputs in enumerate(train_bar):
            ...
            noise = utils.get_noise(inputs, mode = args.noise_mode,min_noise = args.min_noise/255., max_noise = args.max_noise/255., noise_std = args.noise_std/255.)
        ...
        if epoch % args.valid_interval == 0:
            ...
            for sample_id, sample in enumerate(valid_bar):
                with torch.no_grad():
                    ...
                    noise = utils.get_noise(sample, mode = 'S', noise_std = (args.min_noise +  args.max_noise)/(2*255.))
